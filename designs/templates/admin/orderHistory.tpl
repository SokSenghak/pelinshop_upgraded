		...
		<div class="table-responsive">
			...
			<tbody>
				...
				<td class="text-center" valign="top" width="140px;">
					...
					<a data-toggle="tooltip" data-original-title="print Invoice" class="btn btn-success btn-xs" href="{$index_file}?task=order_list_history&amp;action=printInvoice&amp;id={$data.id}" target="_blank">
					<i class="glyphicon glyphicon-print"></i> បោះពុម្ភ (Print)
					</a>
					<a data-toggle="tooltip" data-original-title="print Invoice No Imei" class="btn btn-info btn-xs" href="{$index_file}?task=order_list_history&amp;action=printInvoiceNoIme&amp;id={$data.id}" target="_blank">
