...
<div class="container">
  ...
  {else}
    {foreach from=$branch_group item=group key=k}
      <table class="table table-bordered" style="margin-bottom: 0;width: 100%">
        <tbody>
          <tr>
            ...
            <td>
              <label class="nopadding" style="font-size:16px;font-weight:bold"> <i class="glyphicon glyphicon-phone"></i> {$group.branch_count} </label>
            </td>
          </tr>
        </tbody>
      </table>
      ...
      {else}
        <table class="table table-bordered" style="margin-bottom: 0;width: 100%">
          {foreach from=$brand_group_name_data item=group}
          <tbody>
            <tr>
              <td style="width:30%">
                <label class="nopadding" style="font-size:16px;font-weight:bold">{$group.name}</label>
