...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-9 nopadding">
      <p class="text-center" style="font-size:20px;font-weight:bold"> Product Transfer Report ({$product_transfer_data.transfered_date|date_format:"d-m-Y H:i:s"}) </p>
      <p></p>
    </div>
    ...
    <div class="col-md-9  nopadding">
      ...
      <table class="table table-bordered">
        <tbody>
					{foreach from=$product_transfer_history item=data key=k}
          <tr>
