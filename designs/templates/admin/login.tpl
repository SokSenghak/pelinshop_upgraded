...
<div class="container">
  <div class="row">
    <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
      <ul class="breadcrumb">
        <li><a href="{$shop_site}"><span class="label label-success">PELIN PHONE</span></a></li>
      ...
      {if $error }
        ...
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          {if $error.username eq 1} <i class="fa fa-exclamation"></i>&nbsp;សូមបញ្ចូលឈ្មោះអ្នកប្រើប្រាស់។ (Please enter your username.) <br />{/if}
          {if $error.password eq 1} <i class="fa fa-exclamation"></i>&nbsp;សូម​បញ្ចូល​ពាក្យ​សម្ងាត់​។ (Please enter your password.) <br />{/if}
          {if $error.login eq 1}    <i class="fa fa-exclamation"></i>&nbsp;ឈ្មោះអ្នកប្រើ ឬពាក្យសម្ងាត់ខុស។ (Wrong username or password.) <br />{/if}
        </div>
      {/if}
      <div class="panel panel-success">
        ...
        <div class="panel-body">
          ...
          <form action="{$admin_file}?task=login" method="post">
