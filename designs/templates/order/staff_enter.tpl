    ...
    <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
      ...
      {if $error }
        ...
        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          {if $error.id eq 1} សូមបញ្ចូលអត្ត ID របស់អ្នក។ (Please enter your ID.) <br/> {/if}
          {if $error.password eq 1} សូម​បញ្ចូល​ពាក្យ​សម្ងាត់​របស់​អ្នក។ (Please enter your password.) <br/> {/if}
          {if $error.stopped eq 1} បុគ្គលិកនេះមិនត្រូវបានអនុញ្ញាតឱ្យពិនិត្យចូលទេ។ (This staff was not allowed to log in.) <br />{/if}
          {if $error.login eq 1} ការពិនិត្យចូលត្រូវបានបដិសេធ។ (Login Denied.) <br /> {/if}
        </div>
      {/if}
