<?php
/* Smarty version 4.1.0, created on 2026-04-17 14:45:44
  from '/home/senghak/Documents/pelinshop_php8/pelinshop_upgraded/designs/templates/admin/storageTask_.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.0',
  'unifunc' => 'content_69e1e528499894_93749521',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '33a8c2336f7e6ee89ad3836e4d24ec1483959552' => 
    array (
      0 => '/home/senghak/Documents/pelinshop_php8/pelinshop_upgraded/designs/templates/admin/storageTask_.tpl',
      1 => 1776406182,
      2 => 'file',
    ),
  ),
...
function content_69e1e528499894_93749521 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_loadInheritance();
$_smarty_tpl->inheritance->init($_smarty_tpl, true);
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_88792609469e1e528480605_45313341', "main");
?>

<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_102332091869e1e5284986a5_01046624', "javascript");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "admin/layout.tpl");
}
/* {block "main"} */
class Block_88792609469e1e528480605_45313341 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'main' => 
  array (
    0 => 'Block_88792609469e1e528480605_45313341',
  ),
);
...
">ទំព័រដើម (Home)</a></li>
  ...
  <?php if ($_smarty_tpl->tpl_vars['error']->value) {?>
    <div class="alert alert-danger" data-dismiss="alert">
      ...
      <?php if ($_smarty_tpl->tpl_vars['error']->value['storage_'] == 1) {?>សូមបញ្ចូលប្រភេទទំហំផ្ទុក។ (Please enter storage name.)<?php }?>
    </div>
  <?php }?>
  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-body">
      <div class="row">
        <div class="col-md-8">
          <?php if ($_smarty_tpl->tpl_vars['storage']->value['id']) {?>
          <form role="form" method="post" action="<?php echo $_smarty_tpl->tpl_vars['admin_file']->value;?>
?task=storage&amp;action=edit&amp;id=<?php echo $_smarty_tpl->tpl_vars['storage']->value['id'];?>
" class="form-inline">
          <?php } else { ?>
          <form role="form" method="post" action="<?php echo $_smarty_tpl->tpl_vars['admin_file']->value;?>
?task=storage" class="form-inline">
          <?php }?>
            <div class="form-group">
              <div class="input-group">
                <input type="text" name="storage_" value="<?php if ($_smarty_tpl->tpl_vars['storage']->value['name']) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['storage']->value['name'], ENT_QUOTES, 'UTF-8', true);
}?>"
                       class="form-control" placeholder="ទំហំផ្ទុក (Storage)..." autofocus>
                <?php if ($_smarty_tpl->tpl_vars['storage']->value['id']) {?>
                  <input type="hidden" name="id" value="<?php echo $_smarty_tpl->tpl_vars['storage']->value['id'];?>
" />
...
?task=storage"><i class="glyphicon glyphicon-remove-circle"></i>&nbsp;បោះបង់ (Cancel)</a>
              <?php }?>
            </div>
          </form>
        </div>
...
?task=storage" class="form-horizontal">
...
" name="kwd" class="form-control" placeholder="ស្វែងរក (Search for)...">
      ...
      <table class="table table-bordered table-striped table-hover">
        ...
        <tbody>
        <?php if (count($_smarty_tpl->tpl_vars['list_storage_data']->value) > 0) {?>
        <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['list_storage_data']->value, 'data');
...
echo (isset($_smarty_tpl->tpl_vars['__smarty_foreach_foo']->value['iteration']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_foo']->value['iteration'] : null)+(($tmp = $_GET['next'] ?? null)===null||$tmp==='' ? 1 ?? null : $tmp)-1;
            ...
            <td class="text-center" valign="top" width="175px;">
              <a data-toggle="tooltip" data-original-title="Edit Storage Name" class="btn btn-xs btn-success" href="<?php echo $_smarty_tpl->tpl_vars['admin_file']->value;?>
?task=storage&amp;action=edit&amp;id=<?php echo $_smarty_tpl->tpl_vars['data']->value['id'];?>
">
...
/* {/block "main"} */
/* {block "javascript"} */
class Block_102332091869e1e5284986a5_01046624 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'javascript' => 
  array (
    0 => 'Block_102332091869e1e5284986a5_01046624',
  ),
);
public function callBlock(Smarty_Internal_Template $_smarty_tpl) {
?>
